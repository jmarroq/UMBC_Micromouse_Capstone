...
static const float CELL_MM        = 180.0f;   // placeholder
static const float MM_PER_TICK    = 1.0f;     // placeholder
static const float TURN_TICKS_90  = 63.0f;    // placeholder
...
static Direction activeTargetDir = DIR_NORTH;
