/*
 ...
 File: Movement_functions.ino
 Description:
 This file contains the low-level hardware definitions and helper functions 
 for the robot's movement subsystem. 
 * It defines motor and encoder pin assignments, sets up physical robot geometry constants
 * It implements the Interrupt Service Routines (ISRs) for tracking encoder ticks.
 * Calculates derived motion parameters like ticks per degree or millimeter.     */
...
void setup() {
  ...
  Serial.println("Booting Layer 2 Movement Test...\n");
